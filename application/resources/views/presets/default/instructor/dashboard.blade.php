...
@section('content')
        ...
        <div class="dash-box">
            <div class="row">
                <div class="col-lg-6 my-auto">
                    <h2 class="mb-0">@lang('Welcome Back')<span> {{auth('instructor')->user()->fullname ?? auth('instructor')->user()->username}}?</span></h2>
                </div>
    ...
    <div class="row gy-4 mx-lg-0">
        <div class="col-xxl-3 col-xl-4 col-lg-6 col-sm-6">
            <a class="d-block" href="{{ route('instructor.home') }}">
                <div class="dashboard-card">
                    ...
                    <div class="dashboard-card__content">
                        <h5 class="dashboard-card__amount">
                            {{ $general->cur_sym . showAmount(auth('instructor')->user()->balance) }}</h5>
                        <h5 class="dashboard-card__title">@lang('Your Balance')</h5>
                    </div>
        ...
        <div class="col-xxl-3 col-xl-4 col-lg-6 col-sm-6">
            <a class="d-block" href="{{ route('instructor.course.index') }}">
                <div class="dashboard-card">
                    <div class="card-shape">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                            <path fill-opacity="1"
                    ...
                    <div class="dashboard-card__content">
                        <h5 class="dashboard-card__amount">{{ $totalCourses }}</h5>
                        <h5 class="dashboard-card__title">@lang('Total Course')</h5>
                    </div>
                    <div class="dashboard-card__icon">
        ...
        <div class="col-xxl-3 col-xl-4 col-lg-6 col-sm-6">
            <a class="d-block" href="{{ route('instructor.course.index') }}">
                <div class="dashboard-card">
                    ...
                    <div class="dashboard-card__content">
                        <h5 class="dashboard-card__amount">{{ $enrollCount }}</h5>
                        <h5 class="dashboard-card__title">@lang('Total Enrolls')</h5>
                    </div>
                    <div class="dashboard-card__icon">
        ...
        <div class="col-xxl-3 col-xl-4 col-lg-6 col-sm-6">
            <a class="d-block" href="{{ route('ticket.open') }}">
                <div class="dashboard-card">
                    ...
                    <div class="dashboard-card__content">
                        <h5 class="dashboard-card__amount">{{ $ticket->instructorOpen()->count() }}</h5>
    ...
    <div>
        <div class="title ms-3 mb-4 mt-4">
        ...
        (function() {
            var options = {
                ...
                series: [{
                    ...
                    type: 'area',
                    data: @json($withdrawChart['values'])
                }],
                fill: {
                    opacity: [0.85, 1],
                },
